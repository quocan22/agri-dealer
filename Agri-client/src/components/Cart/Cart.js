      ...
      "Bạn không có sản phẩm nào trong giỏ hàng" :  
        <Grid className="cart-row">
          ...
          >
           ...
           <Typography variant="subtitle1" style={{ margin: 5,fontWeight:550, justifyContent:"flex-start" }}>
                Tạm tính:
              </Typography>
 
           {cartData.map((cproduct) => (
              <Grid className="row" style={{ justifyContent:"space-between" }}>
              <Typography variant="subtitle1" style={{ margin: 5, alignContent:"center", width:"100px" }} align="left">
               {cproduct.productName}
              </Typography>
              <Typography variant="subtitle3" style={{ margin: 10, alignItems:"flex-end", justifyContent:"flex-start", color:"orange" }} align="center">
               x {cproduct.buyQuantity}
              </Typography>
              <text style={{margin: 9, alignContent:"center", fontWeight: "bold",width:"80px" }} align="right">{numberWithCommas(cproduct.productPrice*cproduct.buyQuantity)}₫</text>
              </Grid>
            ))}
            
            <Grid className="row">
            <Typography variant="subtitle1" style={{ margin: 5,fontWeight:550 }}>
              Tổng cộng:
            </Typography>
            <text style={{margin: 9, alignContent:"center", fontWeight: "bold" }}>
            {cartData.forEach((cproduct) => (
            ...
            <text style={{ margin: 7, alignContent:"center",fontWeight:650, fontSize:18, color:"red"}}>{numberWithCommas(total)}₫</text>
            </Grid>
            </Card>
            <Button className="buy-btn" onClick={PaidCart}>đặt hàng</Button>
          </Grid>
